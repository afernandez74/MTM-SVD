...
summary_table = pd.read_csv('/Volumes/AlejoED/Work/MannSteinman_Proj/Data/pages2k/pages2k_proxy_summary_table.csv')
...
for index, row in df_interp.iterrows():
    ...
    # save .nc files
    save_path = os.path.expanduser("~/mtm_local/pages2k/datasets/")
